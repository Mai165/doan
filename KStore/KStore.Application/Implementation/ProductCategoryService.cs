...
namespace KStore.Application.Implementation
{
    public class ProductCategoryService : IProductCategoryService
    {
        ...
        public ProductCategoryService(IRepository<ProductCategory, int> productCategoryRepository, IRepository<Product, int> productRepository,
        ...
        public List<ProductCategoryViewModel> GetHomeCategories(int top)
        {
            ...
            {
                category.Products = _mapper.ProjectTo<ProductViewModel>(_productRepository
