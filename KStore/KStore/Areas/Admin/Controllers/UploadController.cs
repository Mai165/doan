    ...
    public class UploadController : BaseController
    {
        ...
        public IActionResult UploadImage()
        {
            ...
            else
            {
                ...
                List<string> pattFileList = new List<string>();
                foreach (var file in files)
                {
                    ...
                    imageFolder = $@"\uploaded\images\{now.ToString("yyyyMMdd")}";
                    ...
                    pattFileList.Add(Path.Combine(imageFolder, filename).Replace(@"\", @"/"));
                }
                return new OkObjectResult(pattFileList);
            }
        }
    }
}
