        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            kstore.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        kstore.notify('Deleted success', 'success');
                        kstore.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        kstore.notify('Update success', 'success');
                    ...
                    error: function () {
                        kstore.notify('Has an error in update progress', 'error');
                        kstore.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = kstore.unflattern(data);
