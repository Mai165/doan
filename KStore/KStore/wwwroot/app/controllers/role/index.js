    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        kstore.notify('Update role successful', 'success');
                    ...
                    error: function () {
                        kstore.notify('Has an error', 'error');
                        kstore.stopLoading();
                    }
                });
                return false;
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            kstore.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    error: function (status) {
                        kstore.notify('Has an error in deleting progress', 'error');
                        kstore.stopLoading();
                    }
                });
            });
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    kstore.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    kstore.stopLoading();
                },
                error: function () {
                    kstore.notify('Has an error in save permission progress', 'error');
                    kstore.stopLoading();
                }
            });
        });
