var productController = function () {
    ...
    function registerEvents() {
        ...
        $('#btn-export').on('click', function () {
            $.ajax({
                ...
                error: function () {
                    kstore.notify('Has an error in progress', 'error');
                    kstore.stopLoading();
                }
            });
        });
    ...
    function saveProduct(e) {
        if ($('#frmMaintainance').valid()) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    kstore.notify('Update product successful', 'success');
                ...
                error: function () {
                    kstore.notify('Has an error in save product progress', 'error');
                    kstore.stopLoading();
                }
            });
            return false;
    ...
    function deleteProduct(id) {
        kstore.confirm('Are you sure to delete?', function () {
            $.ajax({
                ...
                success: function (response) {
                    kstore.notify('Delete successful', 'success');
                    kstore.stopLoading();
                    loadData();
                },
                error: function (status) {
                    kstore.notify('Has an error in delete progress', 'error');
                    kstore.stopLoading();
                }
            });
        });
    ...
    function initTreeDropDownCategory(selectedId) {
        $.ajax({
            ...
            success: function (response) {
                ...
                var arr = kstore.unflattern(data);
    ...
    function loadCategories() {
        $.ajax({
            ...
            error: function (status) {
                console.log(status);
                kstore.notify('Cannot loading product category data', 'error');
            }
        });
    }
    ...
    function loadData(isPageChanged) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response.Results, function (i, item) {
                    render += Mustache.render(template, {
                        ...
                        Price: kstore.formatNumber(item.Price, 0),
                        CreatedDate: kstore.dateTimeFormatJson(item.DateCreated),
            ...
            error: function (status) {
                console.log(status);
                kstore.notify('Cannot loading data', 'error');
            }
        });
    }
