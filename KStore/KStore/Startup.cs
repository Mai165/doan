...
using KStore.Application.Dapper.Implementation;
...
namespace KStore
{
    public class Startup
    {
        ...
        {
            loggerFactory.AddFile("Logs/kstore-{Date}.txt");
            ...
            {
                routes.MapHub<KStoreHub>("/KStoreHub");
